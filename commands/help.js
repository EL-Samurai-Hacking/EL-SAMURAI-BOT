...
async function helpCommand(sock, chatId, message) {
    const helpMessage = `
╔═══════════════════╗
   *🤖 ${settings.botName || 'EL SAMURAI BOT'}🦾*  
   Version: *${settings.version || '2.0.2'}*
   by ${settings.botOwner || 'EL SAMURAI'}
   YT : ${global.ytch}
╚═══════════════════╝
...
مرحبا بك في بوت المطور 𝑬𝑳 𝑺𝑨𝑴𝑼𝑹𝑨𝑰 يمكنك استخدام البوت هاذي كل اوامر البوت لنا الابداع ولكم الاستمتاع


يمكنك متابعة المطور 

موقع المطور👇
https://shorturl.at/O6Uxv
〰️〰️〰️〰️〰️〰️〰️〰️〰️
قناتي 👇
https://t.me/samurai_updates
〰️〰️〰️〰️〰️〰️〰️〰️〰️
بوت تعليم الهكر 👇
https://t.me/White_Hackingbot
〰️〰️〰️〰️〰️〰️〰️〰️〰️:`;
